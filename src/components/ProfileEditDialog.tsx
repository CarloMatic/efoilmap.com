...
export function ProfileEditDialog({ open, onClose }: ProfileEditDialogProps) {
    ...
    const handleAvatarUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
        ...
        try {
            ...
            showToast(t('common.success') || "Foto optimiert & hochgeladen!", "success");
        } catch (error: any) {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            showToast(t('common.success') || "Profil aktualisiert!", "success");
            onClose();
        } catch (error: any) {
            showToast(error.message, "error");
        } finally {
            ...
            <div className="relative w-full max-w-md bg-gray-900 border border-white/20 rounded-[32px] shadow-2xl overflow-hidden animate-in zoom-in-95">
                <div className="p-8">
                    ...
                    <div className="flex flex-col items-center mb-8">
                        ...
                        <p className="text-xs text-gray-400 mt-3">{t('auth.avatar_desc') || "Klicke zum Ändern"}</p>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div className="space-y-2">
                            <label className="text-xs font-semibold text-gray-300 uppercase tracking-wider ml-1">{t('auth.bio') || "Über mich"}</label>
                            <div className="relative">
                                ...
                                <textarea
                                    ...
                                    rows={3}
                                    placeholder={t('auth.bio_placeholder') || "Erzähl uns etwas über dich..."}
