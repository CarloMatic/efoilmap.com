...
export default function IntroModal() {
    ...
    return (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-background/80 backdrop-blur-md transition-all">
            <div className="max-w-md w-full bg-card border border-border rounded-[2rem] shadow-2xl p-8 flex flex-col items-center text-center space-y-8 animate-in fade-in zoom-in duration-300">
